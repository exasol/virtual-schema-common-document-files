# Virtual Schema for Document Data in Files 8.1.13, released 2026-02-19

Code name: Implement support for array of items and json-line documents

## Summary

This release implements support for array of items and json-line documents

## Features

* #181: JSON: Implement support for array of items and json-line documents

## Dependency Updates

### Compile Dependency Updates

* Updated `com.exasol:virtual-schema-common-document:11.0.6` to `11.0.7`
